...
START_TEST(s21_div_10) {
  s21_decimal dec1 = {{100, 0, 0, 0}, NORMAL};
  s21_decimal dec2 = {{99999, 0, 0, 0}, NORMAL};
...
START_TEST(s21_div_13) {
  s21_decimal dec1 = {{10.0e3, 0, 0, 0}, NORMAL};
  s21_decimal dec2 = {{2.00e2, 0, 0, 0}, NORMAL};
...
START_TEST(s21_div_null_14) {
  s21_decimal dec1 = {{1110, 0, 0, 0}, NORMAL};
  s21_decimal dec2 = {{0, 0, 0, 0}, NORMAL};
