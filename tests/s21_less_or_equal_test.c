...
START_TEST(s21_test_is_less_or_equal_1) {
  s21_decimal a = {{1, 0, 0, 0}, NORMAL};
  s21_decimal b = {{1, 0, 0, 0}, NORMAL};
...
START_TEST(s21_is_less_or_equalTest01) {
  // 2596
  s21_decimal src1 = {{3, 0, 0, 0}, NORMAL};
  s21_decimal src2 = {{0, 0, 0, 0}, NORMAL};
...
Suite *suite_s21_less_or_equal_test(void) {
  Suite *s;
  TCase *tc;
  s = suite_create("s21_less_or_equal_test");
