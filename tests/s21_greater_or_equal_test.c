...
START_TEST(s21_greater_or_equal_13) {
  ...
  s21_decimal dec7 = {{12345, 0, 0, 0b10000000000001000000000000000000},
                      NORMAL};  // -1.2345
  s21_decimal dec8 = {{12, 0, 0, 0b00000000000000010000000000000000}, NORMAL};
  ...
  s21_decimal dec1 = {{12345, 0, 0, 0b00000000000001000000000000000000},
                      NORMAL};  //  1.2345
  s21_decimal dec2 = {{12, 0, 0, 0b00000000000000010000000000000000}, NORMAL};
  ...
  s21_decimal dec9 = {{12345, 0, 0, 0}, NORMAL};
  s21_decimal dec10 = {{12345, 0, 0, 0}, NORMAL};
  ck_assert_int_eq(s21_is_greater_or_equal(dec9, dec10), 1);
  ck_assert_int_eq(s21_is_greater_or_equal(dec10, dec9), 1);

  s21_decimal dec11 = {{0, 0, 0, 0}, NORMAL};
  s21_decimal dec12 = {{0, 0, 0, 0}, NORMAL};
...
Suite *suite_s21_greater_or_equal_test(void) {
  Suite *s;
  TCase *tc;
  s = suite_create("s21_greater_or_equal_test");
