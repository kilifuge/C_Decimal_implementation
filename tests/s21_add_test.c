...
START_TEST(add_test_21) {
  int tmp1 = 4294967295;
  s21_decimal dec1 = {{tmp1, tmp1, tmp1, 0}, NORMAL};
...
START_TEST(add_test_22) {
  int tmp1 = 4294967295;
  float tmp2 = pow(2, 31);
  s21_decimal dec1 = {{tmp1, tmp1, tmp1, tmp2}, NORMAL};
  s21_decimal dec2 = {{1, 0, 0, tmp2}, NORMAL};
  s21_decimal res1;
  int ret_s21 = s21_add(dec1, dec2, &res1);
...
START_TEST(add_1) {
  s21_decimal val1 = {{8, 0, 0, 0}, NORMAL};
  s21_decimal val2 = {{2, 0, 0, 0}, NORMAL};
  s21_decimal res = {0};
...
START_TEST(add_2) {
  s21_decimal val1 = {{2, 0, 0, 0}, NORMAL};
  s21_decimal val2 = {{8, 0, 0, 0}, NORMAL};
  s21_decimal res = {0};
  ck_assert_int_eq(0, s21_add(val1, val2, &res));
}
END_TEST
...
START_TEST(s21_add_max_27) {
  ...
  original_res.bits[0] = 0b11111111111111111111111111111101;
...
START_TEST(s21_add_max_28) {
  ...
  src2.bits[3] = 0b00000000000000000000000000000000;
  s21_decimal original_res = {0};
  original_res.bits[0] = 0b11111111111111111111111111111010;
  original_res.bits[1] = 0b11111111111111111111111111111111;
  original_res.bits[2] = 0b11111111111111111111111111111111;
  original_res.bits[3] = 0b10000000000000000000000000000000;
  s21_decimal s21_res = {0};
...
Suite* suite_s21_add_test(void) {
  ...
  tcase_add_test(tc, s21_add_max_24);
  tcase_add_test(tc, s21_add_max_25);
  tcase_add_test(tc, s21_add_max_26);
  tcase_add_test(tc, s21_add_max_27);
  tcase_add_test(tc, s21_add_max_28);
  tcase_add_test(tc, s21_add_max_29);
